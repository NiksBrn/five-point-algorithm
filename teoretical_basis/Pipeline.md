...
Итерационный процесс:
    Пока не достигнуто расчетное число итераций:
        ...
        Шаг 3: Для каждого кандидата E:
            ...
            • Подсчет инлаеров (точек с ошибкой < порога)
...
Шаг 1: SVD разложение матрицы E
    ↓
Шаг 2: Коррекция сингулярных значений ($\sigma _1 =\sigma _2, \sigma _3 = 0 $)
    ↓
...
Шаг 4: Выбор правильной комбинации через триангуляцию:
    • Для каждой пары (R, t) выполняем DLT триангуляцию инлаеров
